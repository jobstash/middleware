...
export const FILTER_CONFIG_PRESETS = {
  ...
  organizations: {
    ...
    growingTeam: {
      ...
      show: false,
      googleAnalyticsEventName: "filter_search_growing_team",
      kind: FilterKind.SINGLE_SELECT,
      options: SINGLE_SELECT_OPTIONS.organizations.growingTeam,
    },
    shrinkingTeam: {
      position: 91,
      label: "Lead Step-Downs (legacy)",
      show: false,
      googleAnalyticsEventName: "filter_search_shrinking_team",
      kind: FilterKind.SINGLE_SELECT,
      options: SINGLE_SELECT_OPTIONS.organizations.shrinkingTeam,
    },
    earlyTeamShrinkage: {
      position: 92,
      label: "Early Lead Departures (legacy)",
      show: false,
      googleAnalyticsEventName: "filter_search_early_team_shrinkage",
      kind: FilterKind.SINGLE_SELECT,
      options: SINGLE_SELECT_OPTIONS.organizations.earlyTeamShrinkage,
    },
    recentlyFunded: {
      position: 21,
