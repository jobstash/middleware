...
const jobParameters = (): MatrixParameter[] => [
  ...
  numberParameter("minActiveLeads", 1, 100),
  numberParameter("maxActiveLeads", 10, 101),
  ...
  booleanParameter("earlyLeadDepartures"),
...
export const FILTER_ENDPOINT_SPECS: FilterEndpointSpec[] = [
  ...
  },
  {
    ...
    parameters: [
      ...
      numberParameter("minKnownRoundCapital", 1_000_000, 1_000_000_000),
      numberParameter("minPortfolioCount", 10, 1_000),
      numberParameter("minProgressionRate", 25, 100),
      booleanParameter("hasJobs"),
      booleanParameter("hasTeamSocials"),
      booleanParameter("hasSoloInvestments"),
      {
        name: "sector",
        values: [
